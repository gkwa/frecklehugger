...
import (
	...
	"github.com/gkwa/frecklehugger/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.frecklehugger.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".frecklehugger")
	}
